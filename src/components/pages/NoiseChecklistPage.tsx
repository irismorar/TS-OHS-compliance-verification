...
export function NoiseChecklistPage({
  currentRoute,
  questionCategories,
  ...
  if (currentRoute !== "noiseChecklist") {
    return null;
  }

  return (
    <>
      <QuestionsFormHeader checklistSelectionName="locații unde există nivel ridicat de zgomot" />
      <QuestionsFormMain
