...
export const WORKPLACE_QUESTION_DATA: QuestionData = [
  {
    ...
    questions: [
      ...
      {
        questionText:
          "Instruirea periodică este efectuată conform programului?",
        safetyMeasure:
      ...
      {
        questionText:
          "Există trusa medicală de prim ajutor, verificată și completă?",
        safetyMeasure:
  ...
  },
  {
    ...
    questions: [
      ...
      {
        questionText: "Iluminatul este corespunzător, natural/artificial?",
        safetyMeasure:
          "Se va efectua cel puțin anual măsurarea fluxului luminos la locurile de muncă.",
      },
      {
        questionText: "Ventilația/aerisirea este adecvată?",
        safetyMeasure:
      ...
      {
        questionText:
          "Temperatura este corespunzătoare activității desfășurate?",
        safetyMeasure:
      ...
      {
        questionText:
          "Starea generală de curățenie și ordine este satisfăcătoare?",
        safetyMeasure:
      ...
      {
        questionText:
          "Există protecții pentru părțile în mișcare ale utilajelor?",
        safetyMeasure:
  ...
  },
  {
    ...
    questions: [
      ...
      {
        questionText: "Zonele cu risc de electrocutare sunt semnalizate?",
        safetyMeasure:
          "Se va reface semnalizarea de atenționare a pericolului de electrocutare.",
      },
      {
        questionText: "Lucrările în spații închise au proceduri speciale?",
  ...
  },
  {
    ...
    questions: [
      {
        questionText:
          "Executantul este apt medical pentru activitatea desfășurată?",
        safetyMeasure: "Supravegherea efectuării vizitelor medicale periodice.",
      },
      {
        questionText: "Executantul a primit instruire SSM completă și la zi?",
        safetyMeasure:
  ...
  },
  {
    ...
    questions: [
      {
        questionText:
          "Echipamentele de muncă sunt în stare bună de funcționare?",
        safetyMeasure:
          "Verificarea planului de mentenanță și a procedurii de solicitare reparații și verificări.",
      },
      {
        questionText: "Echipamentele de muncă au verificări periodice la zi?",
        safetyMeasure:
      ...
      {
        questionText:
          "Echipamentele de muncă au protecții funcționale și complete?",
        safetyMeasure:
  ...
  },
  {
    ...
    questions: [
      ...
      {
        questionText: "Mediul are sisteme de ventilație și evacuare adecvate?",
        safetyMeasure:
          "Numirea responsabilului cu aceste sisteme, verificarea zilnică a funcționării corecte a sistemelor.",
      },
      {
        questionText: "Mediul este semnalizat corespunzător?",
        safetyMeasure:
